...
from .routers import (
    ...
    surgeon_availability, surgeon_call_schedule, surgeon_day_items, surgeon_otp,
    surgeon_request_off, surgeon_patients, surgeon_schedule, surgeon_surgical_cases,
)
...
app.include_router(surgeon_patients.router)
