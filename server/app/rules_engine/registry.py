...
def _build_rules() -> list[RuleDef]:
    ...
    return [
        RuleDef(
            ...
            category="overlap",
            description="Approved day off vs any other commitment that day (time-aware for partial days)",
            default_config={},
            config_schema=[],
        ...
        RuleDef(
            ...
            name="OR block overlap",
            category="overlap",
            description="Assigned Block OR placement vs day off / clinic / other commitments",
            default_config={},
            config_schema=[],
            checker=check_overlap_or_block,
        ),
        RuleDef(
        ...
        RuleDef(
            ...
            category="buffer",
            description="Not flagged: morning clinic then afternoon OR is a normal day",
        ...
        RuleDef(
            ...
            category="buffer",
            description="Not flagged: block until noon then a 1pm clinic is the doctor's call to the office",
            default_config={"minutes": 30},
            config_schema=[{"key": "minutes", "type": "number", "label": "Minutes"}],
        ...
        RuleDef(
            ...
            category="buffer",
            description="Not flagged: AM then PM at the same site is scheduled time",
            default_config={"minutes": 30},
            config_schema=[{"key": "minutes", "type": "number", "label": "Minutes"}],
        ...
        RuleDef(
            ...
            category="location",
            description="Not flagged: hospital AM then office PM is the paper day; running late is a phone call",
